...
\geometry{a4paper,left=3cm,right=1cm,top=2cm,bottom=2cm,includehead=false,includefoot=false}
...
\usepackage{wrapfig}
\usepackage{tikz}                                   % Векторные диаграммы (схема конвейера)
...
\setlength{\parindent}{1.25cm}                       % Абзацный отступ. Должен быть одинаковым по всему тексту и равен 1.25 см.
